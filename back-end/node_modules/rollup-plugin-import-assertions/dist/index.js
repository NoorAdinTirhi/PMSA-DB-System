...
var acornImportAssertions = require('acorn-import-assertions');
...
function importAssertions(options = {}) {
  ...
  return {
    ...
    options(opts) {
      ...
      if (!opts.acornInjectPlugins.includes(acornImportAssertions.importAssertions)) {
        opts.acornInjectPlugins.push(acornImportAssertions.importAssertions);
      }
      return opts;
    },
    ...
    async transform(inputCode, id) {
      ...
      if (assertType === 'json')
        ...
        try {
          ...
          const code = pluginutils.dataToEsm(parsed, {
...
module.exports = importAssertions;
