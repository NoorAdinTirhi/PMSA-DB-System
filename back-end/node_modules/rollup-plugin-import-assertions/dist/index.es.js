import { importAssertions as importAssertions$1 } from 'acorn-import-assertions';
...
function importAssertions(options = {}) {
  ...
  return {
    ...
    options(opts) {
      ...
      if (!opts.acornInjectPlugins.includes(importAssertions$1)) {
        opts.acornInjectPlugins.push(importAssertions$1);
      }
      return opts;
    },
...
export { importAssertions as default };
